...
$route['timeexptoday'] = 'Reports/timeexptoday';
...
$route['getinvoiceinfobyid'] = 'Billing/getinvoiceinfobyid';
$route['offlinepayment'] = 'Billing/offlinepayment';
$route['viewinvoice/(:any)'] = 'Billing/viewinvoice/$1';
...
//DOCUMENT 
$route['document/unreaddocument'] = 'Document/unreaddocument';
$route['editdoc/(:any)'] = 'Document/editdoc';
$route['viewdocs/(:any)'] = 'Document/viewdocs';
$route['savecomment'] = 'Document/savecomment';
$route['document/firmdocument'] = 'Document/firmdocument';
$route['documents/blankDocuments'] = 'Document/blankDocuments';
$route['document/template'] = 'Document/template';
$route['document/upload'] = 'Document/uploadFileWithDropZone';
