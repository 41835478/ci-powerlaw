            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="country-form">
                        ...
                        <form id="w0" action="<?php echo base_url()?>updatecountry/<?php echo $country_id?>" method="post">
                           <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-countrycode required">
                                            ...
                                            <input type="text" id="country-countrycode" class="form-control" name="CountryCode" maxlength="20" value="<?php echo $countryeditinfo->CountryCode; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-countryname required">
                                            ...
                                            <input type="text" id="country-countryname" class="form-control" name="CountryName" maxlength="255" value="<?php echo $countryeditinfo->CountryName; ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-currencyname required">
                                            ...
                                            <input type="text" id="country-currencyname" class="form-control" name="CurrencyName" maxlength="255" value="<?php echo $countryeditinfo->CountryCode; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-currencycode required">
                                            ...
                                            <input type="text" id="country-currencycode" class="form-control" name="CurrencyCode" maxlength="20" value="<?php echo $countryeditinfo->CurrencyCode; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-currencysymbol required">
                                            ...
                                            <input type="text" id="country-currencysymbol" class="form-control" name="CurrencySymbol" maxlength="20" value="<?php echo $countryeditinfo->CurrencySymbol; ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-phonecode required">
                                            ...
                                            <input type="text" id="country-phonecode" class="form-control" name="PhoneCode" maxlength="5" value="<?php echo $countryeditinfo->PhoneCode; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-supportphone required">
                                            ...
                                            <input type="text" id="country-supportphone" class="form-control" name="SupportPhone" maxlength="20" value="<?php echo $countryeditinfo->SupportPhone; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-supportemail required">
                                            ...
                                            <input type="text" id="country-supportemail" class="form-control" name="SupportEmail" maxlength="256" value="<?php echo $countryeditinfo->SupportEmail; ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-streetaddress required">
                                            ...
                                            <input type="text" id="country-streetaddress" class="form-control" name="StreetAddress" maxlength="255" value="<?php echo $countryeditinfo->StreetAddress; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-suite">
                                            ...
                                            <input type="text" id="country-suite" class="form-control" name="Suite" maxlength="255" value="<?php echo $countryeditinfo->Suite; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-city required">
                                            ...
                                            <input type="text" id="country-city" class="form-control" name="City" maxlength="255" value="<?php echo $countryeditinfo->City; ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-state required">
                                            ...
                                            <input type="text" id="country-state" class="form-control" name="State" maxlength="255" value="<?php echo $countryeditinfo->State; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-country-zipcode">
                                            ...
                                            <input type="text" id="country-zipcode" class="form-control" name="ZipCode" maxlength="255" value="<?php echo $countryeditinfo->ZipCode; ?>">
