                            ...
                            <tbody>
                                <?php foreach ($allcaseinfo as $case) { //echo '<pre>'; print_r($case);?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url()?>viewcase/<?php echo $case['CaseId']; ?>"><?php echo $case['CaseName']; ?></a></td>
                                        <td><?php echo $case['CaseNumber']; ?></td>
                                        <td><?php echo $case['PracticeArea']; ?></td>
                                        <td><?php echo $case['ContactId']; ?></td>
                                        <td><?php echo $case['AttoernyId']; ?></td>
