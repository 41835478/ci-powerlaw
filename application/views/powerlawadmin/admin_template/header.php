    ...
    <div class="navbar-collapse collapse" id="navbar-mobile">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown dropdown-user">
                <a class="dropdown-toggle" data-toggle="dropdown">
                     <?php  $userinfo = $this->SystemAdministratorModel->getuserinfo($_SESSION['admin_id']);  
    ...
    <div class="navbar-collapse collapse" id="navbar-second-toggle">
        <ul class="nav navbar-nav">
			...
			<li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <!-- <li><a href="<?php echo base_url() ?>daycalendar"><i class="icon-user-lock"></i> Day</a></li>
                   <li><a href="<?php echo base_url() ?>managestate"><i class="icon-statistics"></i> Week</a></li>
                    <li><a href="<?php echo base_url() ?>managetimezones"><i class="icon-statistics"></i> Month</a></li>
                    <li><a href="<?php echo base_url() ?>managepackage"><i class="icon-cog3 position-left"></i> Agenda</a></li>-->
                    <li><a href="<?php echo base_url() ?>managelocation"><i class="icon-cog3 position-left"></i> Locations</a></li>
                </ul>
            </li>

            <li>
                <a href="<?php echo base_url() ?>taskmanager">
                    <i class="icon-task position-left"></i>
                    Tasks
                </a>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="<?php echo base_url() ?>managepackage"><i class="icon-cog3 position-left"></i> Manage Packages</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                   <li><a href="<?php echo base_url() ?>viewallcasesadmin"><i class="icon-user-lock"></i> All Cases</a></li>
                    <li><a href="<?php echo base_url() ?>viewallopencasesadmin"><i class="icon-user-lock"></i> All Open Casses</a></li>
                    <li><a href="<?php echo base_url() ?>viewallclosecasesadmin"><i class="icon-statistics"></i> All Closed Cases</a></li>
					<li><a href="<?php echo base_url() ?>practicearea"><i class="icon-statistics"></i> Practice Areas</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url() ?>showcasedocument"><i class="icon-user-lock"></i> Case Documents</a></li>
                    <li><a href="<?php echo base_url() ?>unreadcasedocument"><i class="icon-statistics"></i> Unread Case Documents</a></li>
                    <li><a href="<?php echo base_url() ?>firmdocuments"><i class="icon-statistics"></i> Firm Documents</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url() ?>billingDashboard"><i class="icon-user-lock"></i> Billing Dashboard</a></li>
                    <li><a href="<?php echo base_url() ?>alltimeentries"><i class="icon-statistics"></i> Time Entries</a></li>
                    <li><a href="#"><i class="icon-statistics"></i> Expenses Head</a></li>
                    <li><a href="#"><i class="icon-statistics"></i> Expenses</a></li>
                    <li><a href="<?php echo base_url() ?>invoiceslist"><i class="icon-statistics"></i> Invoices</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url() ?>inboxmsg"><i class="icon-user-lock"></i> Inbox</a></li>
