    ...
    <div class="navbar-collapse collapse" id="navbar-second-toggle">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url() ?>viewallcases"><i class="icon-user-lock"></i> All Cases</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url() ?>casedocument"><i class="icon-user-lock"></i> Case Documents</a></li>
