        ...
        <div class="content-wrapper">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <div class="firm-form">
                        <form id="w0" action="<?php echo base_url()?>createfirm" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group field-firm-firmname required">
                                        ...
                                        <input type="text" id="firm-firmname" class="form-control" name="FirmName" maxlength="255">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group field-firm-subdomain">
                                        ...
                                        <input type="text" id="firm-subdomain" class="form-control" name="SubDomain" maxlength="255">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group field-firm-contactlname required">
                                        ...
                                        <input type="text" id="firm-contactlname" class="form-control" name="ContactFName" maxlength="255">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group field-firm-contactlname required">
                                        ...
                                        <input type="text" id="firm-contactlname" class="form-control" name="ContactLName" maxlength="255">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group field-firm-ccodem required">
                                        ...
                                        <input type="text" id="firm-mobile" class="form-control" name="Mobile" maxlength="255" data-mask="999-999-9999" style="width: 59%; margin-top: -13px; float: left;">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group field-firm-ccodep">
                                        ...
                                        <select id="firm-ccodep" class="form-control" name="CCodeP" onchange="getState(this.value)" style="width: 37%; float: left; margin-right: 10px;">
                                            ...
                                            <option value="<?php echo $phonecode['PhoneCode']; ?>"><?php echo $phonecode['CountryCode']; ?> (<?php echo $phonecode['PhoneCode']; ?>)</option>
                                            <?php } ?>
                                        </select>
                                        ...
                                        <input type="text" id="firm-phone" class="form-control" name="Phone" maxlength="255" data-mask="999-999-9999" style="width: 59%; margin-top: -13px; float: left;">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group field-firm-ccodef">
                                        ...
                                        <input type="text" id="firm-fax" class="form-control" name="Fax" maxlength="20" data-mask="999-999-9999" style="width: 59%; margin-top: -13px; float: left;">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group field-firm-website">
                                        ...
                                        <input type="text" id="firm-website" class="form-control" name="Website" maxlength="255">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group field-firm-email required">
                                        ...
                                        <input type="text" id="firm-email" class="form-control" name="Email" maxlength="50">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group field-firm-address1">
                                        ...
                                        <input type="text" id="firm-address1" class="form-control" name="Address1" maxlength="255">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group field-firm-address2">
                                        ...
                                        <input type="text" id="firm-address2" class="form-control" name="Address2" maxlength="255">
                                        <div class="help-block"></div>
                                    </div>        </div>
                                <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group field-firm-city">
                                        ...
                                        <input type="text" id="firm-city" class="form-control" name="City" maxlength="255">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group field-firm-zipcode">
                                        ...
                                        <input type="text" id="firm-zipcode" class="form-control" name="ZipCode" maxlength="20">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group field-firm-strength">
                                        ...
                                        <input type="text" id="firm-strength" class="form-control" name="Strength" maxlength="20">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group field-firm-notification">
                                        ...
                                        <input type="text" id="firm-notification" class="form-control" name="Notification" maxlength="50">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group field-firm-nfrequencey">
                                        ...
                                        <input type="text" id="firm-nfrequencey" class="form-control" name="NFrequencey" maxlength="50">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group field-firm-timezoneid">
                                        ...
                                        <select id="firm-timezoneid" class="select-search" name="TimeZoneId">
                                            ...
                                            <option value="<?php echo $timezone['TimezoneId']; ?>"><?php echo $timezone['TimezoneName']; ?></option>
                                              <?php } ?>
                                        </select>
                            ...
                            <div class="form-group" align="center">
                                <button type="submit" class="btn btn-success">Create New Firm</button>    </div>
