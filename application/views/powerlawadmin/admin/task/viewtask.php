                                                ...
                                                <tbody><tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="reminder_info">
                                                            ...
                                                            <a data-toggle="modal" data-target="#editreminder" onclick="">Edit Reminders</a>
...
<!-- Modal -->
<div id="editreminder" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">Set Task Reminders</h4>
            </div>
                ...
                <div class="">
                    <div class="col-md-3">
                        <select name="remainder_type[]" id="remainder_type" class="form-control">
                            <option value="email" <?php if($rem['remainder_type'] == 'email') { echo "selected"; }?>>email</option>
                            <option value="popup" <?php if($rem['remainder_type'] == 'popup') { echo "selected"; }?>>popup</option>
                        </select>
                    </div>
                    <div class="col-md-2">
                        <input type="text" name="remainder_duration[]" id="remainder_duration" value="<?php echo $rem['remainder_duration']; ?>" class="reminder_input form-control">
                    </div>
                    <div class="col-md-4">
                        <select name="remainder_duration_type[]" id="task_reminders__duration" class="form-control">
                            <option value="day" <?php if($rem['remainder_duration_type'] == 'day') { echo "selected"; }?>>days</option>
                            <option value="week" <?php if($rem['remainder_duration_type'] == 'week') { echo "selected"; }?>>weeks</option>
                        </select>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-1">
                        <div class="form-control-static">
                            <a onClick=""><i class="glyphicon glyphicon-remove" style="color: red;"></i></a>
                        </div>
                    </div>
                </div>
                <?php } ?>
