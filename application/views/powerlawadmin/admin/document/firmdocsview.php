                ...
                <div class="panel-body">
                    <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" class="table-responsive"> 
                        <table class="table table-bordered" id="firmdatatables" style="border: 1px solid #ddd;  word-wrap:break-word;">
                            ...
                            <tbody>
                                <?php foreach ($allfirmdocinfo as $firmdoc) {                                        //print_r($doc); ?>
                                    <tr>
                                        <td><?php echo $firmdoc['DocumentId']; ?></td>
                                        <td><a><?php echo $firmdoc['FirmName']; ?></a></p></td>
                                        <td><a><?php echo $firmdoc['OriginalName']; ?></a><p><?php echo $firmdoc['OriginalName']; ?></p></td>
                                        <td><a><?php echo $firmdoc['CaseName']; ?></a></td>
                                        <td>Updated On <?php echo date('d F, Y', strtotime($firmdoc['UploadedOn'])); ?><p>By <a><?php echo $firmdoc['fullname']; ?></a></p></td>
                                        <td>
                                            ...
                                            <a href="<?php echo base_url() ?>editfirm/<?php //echo $firm['FirmId'];        ?>" title="Update" aria-label="Update" data-pjax="0"><span class="glyphicon glyphicon-comment"></span></a>
                                            <a href="<?php echo base_url() ?>editfirm/<?php //echo $firm['FirmId'];        ?>" title="Update" aria-label="Update" data-pjax="0"><span class="glyphicon glyphicon-pencil"></span></a>
