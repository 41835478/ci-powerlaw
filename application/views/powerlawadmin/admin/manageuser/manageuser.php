                ...
                <div class="panel-body">
                    <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" class="table-responsive"> 
                        <table class="table table-bordered" id="manageuserdatatables" style="border: 1px solid #ddd;  word-wrap:break-word;">
                            ...
                            <tbody>
                                <?php foreach ($alluserinfo as $userinfo) {  //print_r($userinfo); ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url() ?>edituser/<?php echo $userinfo['id']; ?>" title="Update" aria-label="Update" data-pjax="0"><span class="glyphicon glyphicon-pencil"></span></a> <a class="alertForDelete" href="<?php echo base_url() ?>deleteuser/<?php echo $userinfo['id']; ?>" title="Delete" aria-label="Delete" data-confirm="Are you sure you want to delete this item?" data-method="post" data-pjax="0"><span class="glyphicon glyphicon-trash"></span></a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
...
<script>
    $(document).ready(function () {
        $('#manageuserdatatables').DataTable({
        });
    });
</script>
