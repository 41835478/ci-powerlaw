            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="country-form">
                        ...
                        <form id="w0" action="<?php echo base_url() ?>createpackage" method="post">
                            <fieldset>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-country-countrycode required">
                                            ...
                                            <input type="text" id="country-countrycode" class="form-control" name="PackageName" maxlength="20">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-country-countryname required">
                                           ...
                                           <textarea rows="4" cols="50" type="text" id="state-statename" class="form-control" name="Description" placeholder="Time Zone"></textarea>
                                            <div class="help-block"></div>
                                        </div>            
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-country-countrycode required">
                                            ...
                                            <input type="text" id="country-countrycode" class="form-control" name="Amount" maxlength="20">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-country-countrycode required">
                                            ...
                                            <select id="state-countryid" class="select-search" name="FreeTrial">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-country-countrycode required">
                                            ...
                                            <input type="text" id="country-countrycode" class="form-control" name="TrialDuration" maxlength="20">
                                            <div class="help-block"></div>
                                        </div>            
                                    </div>
                                </div>
