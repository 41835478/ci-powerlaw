            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    ...
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li>
                                <a href="<?php echo base_url() ?>addNewLocation"><span class="label label-success label-icon"><i class="glyphicon glyphicon-plus"></i></span></a>                                </li>
                            <li class="dropdown">
                                ...
                                <?php foreach ($locationinfo as $location) { ?>
                                    <tr>
                                        ...
                                        <td><a target="_blank" href="https://www.google.com.jm/maps/place/<?php echo $location['address']; ?>/@<?php echo $location['latitude']; ?>/@<?php echo $location['longitude']; ?>,6z?hl=en" title="Update" aria-label="Update" data-pjax="0"><img src='<?php echo base_url() ?>assets/image/map.png'></a>
                                            <a href="<?php echo base_url() ?>editlocation/<?php echo $location['location_id']; ?>" title="Update" aria-label="Update" data-pjax="0"><span class="glyphicon glyphicon-pencil"></span></a> 
                                            <a class="alertForDelete" href="<?php echo base_url() ?>deletelocation/<?php echo $location['location_id']; ?>" title="Delete" aria-label="Delete" data-confirm="Are you sure you want to delete this item?" data-method="post" data-pjax="0"><span class="glyphicon glyphicon-trash"></span></a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
