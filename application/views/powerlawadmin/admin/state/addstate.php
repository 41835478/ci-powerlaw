        ...
        <div class="content-wrapper">
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Create State</h5>
                ...
                <div class="panel-body">
                    ...
                    <div class="state-form">
                        ...
                        <form id="w0" action="<?php echo base_url() ?>createstate" method="post">
                            <fieldset>
                                <div class="row">
                                    <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-state-statename required">
                                            ...
                                            <input type="text" id="state-statename" class="form-control" name="StateName" maxlength="255">
                                            <div class="help-block"></div>
                                        </div>        </div>
                                </div>
