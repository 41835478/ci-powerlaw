        ...
        <div class="content-wrapper">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">All Open Cases</h5>
                ...
                <div class="panel-body">
                    <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" class="table-responsive"> 
                        <table class="table table-bordered" id="countrydatatables" style="border: 1px solid #ddd;  word-wrap:break-word;">
                            ...
                            <tbody>
                                <?php foreach ($allopencaseinfo as $case) { //echo '<pre>'; print_r($case);?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url() ?>editcase/<?php echo $case['CaseId']; ?>" title="Update" aria-label="Update" data-pjax="0"><span class="glyphicon glyphicon-pencil"></span></a> <a href="<?php echo base_url() ?>deletecountry/<?php echo $case['CaseId']; ?>" title="Delete" aria-label="Delete" data-confirm="Are you sure you want to delete this item?" data-method="post" data-pjax="0"><span class="glyphicon glyphicon-trash"></span></a></td>
                                    </tr>
<?php } ?>
                            </tbody>
                        </table>
