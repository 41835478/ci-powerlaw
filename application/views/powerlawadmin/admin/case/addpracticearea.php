            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="state-form">
                        ...
                        <form id="w0" action="<?php echo base_url() ?>createpracticearea" method="post">
                            <fieldset>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-state-statename required">
                                            <label class="control-label" for="state-statename">Practice Area</label>
                                            <input type="text" id="state-statename" class="form-control" name="PracticeArea" maxlength="255">
