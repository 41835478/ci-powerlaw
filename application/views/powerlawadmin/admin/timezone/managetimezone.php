                        ...
                        <ul class="icons-list">
                            ...
                            <li class="dropdown">
                               ...
                               <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="<?php echo base_url() ?>timezoneEXLReport"><i class="icon-file-excel"></i> Export to Excel</a></li>
                                    <li><a href="<?php echo base_url() ?>timezonePDFReport"><i class="icon-file-pdf"></i> Export to PDF</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>					                        
                ...
                <div class="panel-body">
                    <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" class="table-responsive"> 
                        <table class="table table-bordered" id="countrydatatables" style="border: 1px solid #ddd;  word-wrap:break-word;">
                            ...
                            <tbody>
                                <?php foreach ($alltimezoneinfo as $timezone) {  ?>
                                    <tr>
                                        <td><?php echo $timezone['TimezoneId']; ?></td>
                                        <td><?php echo $timezone['TimezoneName']; ?></td>
