            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    ...
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li>
                                <a href="<?php echo base_url() ?>addNewuser"><span class="label label-success label-icon"><i class="glyphicon glyphicon-plus"></i></span></a>                                </li>
                            <li class="dropdown">
...
<!--                                    <th>#</th>-->
                            ...
                            <tbody>
                                <?php foreach ($allusergroupinfo as $usergroup) {  //echo '<pre>'; print_r($usergroup); ?>
                                    <tr>
<!--                                        <td><?php //echo $usergroup['id']; ?></td>-->
                                        <td><?php echo $usergroup['name']; ?></td>
                                        <td><?php echo $subs = $this->ManageuserSystemModel->getusergroupsub($usergroup['name']); ?></td>
                                        <td><?php //echo $userinfo['item_name']; ?></td>
                                        <td><a href="<?php echo base_url()?>editusergroup/<?php echo $usergroup['name'];?>" title="Update" aria-label="Update" data-pjax="0"><span class="glyphicon glyphicon-pencil"></span></a> <a class="alertForDelete" href="<?php //echo base_url()?>deleteuser/<?php //echo $usergroup['id'];?>" title="Delete" aria-label="Delete" data-confirm="Are you sure you want to delete this item?" data-method="post" data-pjax="0"><span class="glyphicon glyphicon-trash"></span></a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
