...
<html lang="en-US">
    ...
    <body>
            ...
            <div class="page-content">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="site-login">
                        <form id="login-form" action="<?php echo base_url() ?>laywerLogin" method="post" role="form">
        ...
        <script type="text/javascript">jQuery(document).ready(function () {
            ...
            });</script><script src="<?php echo base_url() ?>themes/ladmin/layouts/assets/js/jquery-ui.min.js"></script>	<script type="text/javascript" src="/themes/ladmin/layouts/assets/js/core/libraries/bootstrap.min.js"></script>
