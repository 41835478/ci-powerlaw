...
<html lang="en-US">
	<!-- Global stylesheets -->
        <link href="<?php echo base_url()?>themes/ladmin/layouts/assets/css/css.css?family=Roboto:400,300,100,500,700,900" rel="stylesheet" type="text/css">
	...
	<!--<script type="text/javascript" src="/themes/ladmin/layouts/assets/js/pages/dashboard.js"></script>
	 /theme JS files -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-param" content="_csrf">
    <meta name="csrf-token" content="WUtBLlpRLmg9PXAcLyVBBgx7cG9oY1laPgosfzVkXyMuLgBbEDJZEA==">
	...
	<script type="text/javascript" src="<?php echo base_url()?>themes/ladmin/layouts/assets/js/core/libraries/jquery.min.js"></script>
        ...
        <link rel="icon" href="https://cdn.datatables.net/1.10.15/css/jquery.dataTables.min.css" type="image/ico"/>
        <script type="text/javascript" src="https://cdn.datatables.net/1.10.15/js/jquery.dataTables.min.js"></script>
        
        <!------------jquery growl-------------->
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/jquery.growl/stylesheets/jquery.growl.css" media="screen">
        <script type="text/javascript" src="<?php echo base_url() ?>assets/jquery.growl/javascripts/jquery.growl.js"></script>
</head>
<body>