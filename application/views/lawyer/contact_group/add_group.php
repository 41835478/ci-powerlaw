<div class="page-header">
    <div class="page-header-content" style="background: #C8C8C8">
        <ol class="breadcrumb" style="padding-bottom: 10px;">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo base_url()?>contactGroup/addContactGroup">Add Group</a></li>
        </ol>
    </div>
</div>
<!-- /page header -->
        ...
        <div class="content-wrapper">
            <div class="panel panel-flat col-sm-6">
                <div class="panel-heading">
                    <h5 class="panel-title">Create Contact Group</h5>
                ...
                <div class="panel-body">
                    ...
                    <div class="contact-group-form">
                        ...
                        <form id="w0" name="f1" action="<?php echo base_url().'contactGroup/create'?>" method="post">
                            ...
                            <div class="form-group field-contactgroup-groupname required">
                                ...
                                <input type="text" id="contactgroup-groupname" class="form-control" name="GroupName" maxlength="255">
