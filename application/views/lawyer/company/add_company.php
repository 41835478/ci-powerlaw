<div class="page-header">
    <div class="page-header-content" style="background: #C8C8C8">
        <ol class="breadcrumb" style="padding-bottom: 10px;">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url() ?>company">Company</a></li>
            <li class="breadcrumb-item active"><a href="<?php echo base_url() ?>company/addCompany">Add Company</a></li>
        </ol>
    </div>
</div>
<!-- /page header -->
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="company-form">
                        ...
                        <form id="w0" onsubmit="return validateForm()" name="f1" method="post" action="<?php echo base_url() . 'company/add' ?>">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group field-company-companyname required">
                                        ...
                                        <input type="text" id="company-companyname" class="form-control" name="CompanyName" maxlength="255">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group field-company-companyname">
                                        ...
                                        <input type="text" id="company-companyname" class="form-control" name="CompanyEmail" maxlength="255">
                                        <div class="help-block"></div>
                                    </div> 
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group field-company-companyname">
                                        ...
                                        <input type="text" id="company-companyname" class="form-control" name="website" maxlength="255">
                                        <div class="help-block"></div>
                                    </div> 
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group field-company-companyname">
                                        ...
                                        <input type="text" id="company-companyname" class="form-control" name="mobile" maxlength="255">
                                        <div class="help-block"></div>
                                    </div> 
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group field-company-companyname">
                                        ...
                                        <input type="text" id="company-companyname" class="form-control" name="phone" maxlength="255">
                                        <div class="help-block"></div>
                                    </div> 
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group field-company-companyname">
                                        ...
                                        <input type="text" id="company-companyname" class="form-control" name="city" maxlength="255">
                                        <div class="help-block"></div>
                                    </div> 
                                </div>
                                <div class="col-md-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group field-company-companyname">
                                        ...
                                        <input type="text" id="company-companyname" class="form-control" name="zip" maxlength="255">
                                        <div class="help-block"></div>
                                    </div> 
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <button style="margin-top: 26px; width: 110px; font-size: 17px; " type="submit" class="btn btn-success">Create</button>    
                                </div>
                            </div>
