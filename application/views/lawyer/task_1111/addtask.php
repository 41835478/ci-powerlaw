            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="country-form">
                        ...
                        <form id="w0" action="<?php echo base_url() ?>insertnewtask" method="post">
                            <fieldset>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-country-countrycode required">
                                            <label class="control-label" for="country-countrycode">Task Name</label>
                                            <input type="text" id="country-countrycode" class="form-control" name="TaskName" maxlength="20" placeholder="Task Name">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-country-countrycode required">
                                            ...
                                            <select id="state-countryid" class="select-search form-control" name="AssignedTo[]">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-country-countrycode required">
                                            ...
                                            <select id="casedrop" class="select-search form-control" name="CaseId">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-country-countrycode required">
                                            ...
                                            <input type="text" id="firmname" class="form-control" name="firmname" maxlength="20" readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group field-country-countrycode required">
                                            ...
                                            <input type="text" id="country-countrycode" class="form-control" name="Rate" maxlength="20" placeholder="Rate">
                                            <div class="help-block"></div>
                                        </div>            
                                    </div>
                                </div>
