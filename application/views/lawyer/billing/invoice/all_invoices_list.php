                ...
                <div class="panel-body">
                    <div id="w0" class="grid-view">
                        ...
                        <table id="all-contact-table" class="table table-striped table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <?php if(isset($all_expense)){ foreach ($all_expense as $row){?>
                                <tr style="text-align: center;">
                                    ...
                                    <td>
                                        ...
                                        <a href="billing/deleteExpense/<?php echo $row['ExpenseId'];?>" onclick="return chkDelete()">
