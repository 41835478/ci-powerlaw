<div class="page-header">
    <div class="page-header-content" style="background: #C8C8C8">
        <ol class="breadcrumb" style="padding-bottom: 10px;">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo base_url()?>addfrontLocation">Add Location</a></li>
        </ol>
    </div>
</div>
<!-- Page container -->
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="state-form">
                        ...
                        <form id="w0" action="<?php echo base_url() ?>createfrontlocation" method="post">
                            <fieldset>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group field-state-statename required">
                                            <label class="control-label" for="state-statename">Location Name</label>
                                            <input type="text" id="state-statename" class="form-control" name="location_name" maxlength="255">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group field-state-statename required">
                                            ...
                                            <input type="text" id="state-statename" class="form-control" name="address" maxlength="255">
                                            <div class="help-block"></div>
                                        </div>        
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group field-state-statename required">
                                            ...
                                            <input type="text" id="state-statename" class="form-control" name="city" maxlength="255">
                                            <div class="help-block"></div>
                                        </div>        
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                     ...
                                     <div class="col-sm-6">
                                        <div class="form-group field-state-statename required">
                                            ...
                                            <input type="text" id="state-statename" class="form-control" name="zip" maxlength="255">
                                            <div class="help-block"></div>
                                        </div>        
                                    </div>
                                </div>
