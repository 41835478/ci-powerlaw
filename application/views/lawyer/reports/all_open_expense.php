            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    ...
                    <ul class="list-unstyled list-inline">
                        <li><a href="billing/openExpense"><button class="btn btn-info">Open</button></a></li>
                        <li><a href="billing/invoiceExpense"><button class="btn btn-success">Invoiced</button></a></li>
                        ...
                        <table id="all-contact-table" class="table table-striped table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr style="text-align: center;">
                                    ...
                                    <td><?php echo $row['qty'] * $row['ExpenseAmount']?></td>
                                    <td><?php echo 'Open'?></td>
                                    <td><?php echo $row['FirstName'] . ' ' . $row['LastName']?></td>
                                    <td><?php echo $row['CaseName']?></td>
                                    <td>
                                        <a data-toggle="modal" data-target="#editLink<?php echo $row['ExpenseId'];?>" style="cursor: pointer;">
                                            <span data-toggle="tooltip" data-placement="top" title="Edit Category" class="glyphicon glyphicon-edit"></span>
                                        </a>&nbsp;
                                        <a href="admin/deleteSponsor/" onclick="return chkDelete()">
