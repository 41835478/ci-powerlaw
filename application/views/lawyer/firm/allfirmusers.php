<style>
    .rscont {   
        ...
        background: url("http://localhost/mypowerLawServer/assets/image/permissions_bg.jpg") top left repeat-x !important;
        border-radius: 3px;}
    </style>
    ...
    <div class="page-header-content" style="background: #C8C8C8">
        <ol class="breadcrumb" style="padding-bottom: 10px;">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo base_url() ?>allfirmusers">Firm User</a></li>
        </ol>
    </div>
</div>
<!-- /page header -->
                                ...
                                foreach ($allfirmuser as $firmuser) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <p><?php echo $userauthinfo->item_name; ?></p>
                                        </td>
                                        <td>
                                        ...
                                        <td id="permission_183428_row" colspan="9" class="first_child last_child attorney-permission-row border-top-0" style="padding: 0px;">
                                                                ...
                                                                <table class="permissions table table-bordered">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="radio" value="1" <?php if (isset($userpermissioninfo->clients)) {
                                            echo ($userpermissioninfo->clients == '1' ? 'checked' : '');
                                        } ?> name="clients"></td>
                                                                            <td><input type="radio" <?php if (isset($userpermissioninfo->clients)) {
                                            echo ($userpermissioninfo->clients == '2' ? 'checked' : '');
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="radio" value="1" <?php if (isset($userpermissioninfo->cases)) {
                                            echo ($userpermissioninfo->cases == '1' ? 'checked' : '');
                                        } ?> name="cases"></td>
                                                                            <td> <input type="radio" value="2" <?php if (isset($userpermissioninfo->cases)) {
                                            echo ($userpermissioninfo->cases == '2' ? 'checked' : '');
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td> <input type="radio" value="1" <?php if (isset($userpermissioninfo->events)) {
                                            echo ($userpermissioninfo->events == '1' ? 'checked' : '');
                                        } ?>  name="events"></td>
                                                                            <td> <input type="radio" value="2" <?php if (isset($userpermissioninfo->events)) {
                                            echo ($userpermissioninfo->events == '2' ? 'checked' : '');
                                        } ?> name="events"></td>
                                                                            <td><input type="radio" value="3" <?php if (isset($userpermissioninfo->events)) {
                                            echo ($userpermissioninfo->events == '3' ? 'checked' : '');
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="radio" value="1" <?php if (isset($userpermissioninfo->documents)) {
                                            echo ($userpermissioninfo->documents == '1' ? 'checked' : '');
                                        } ?> name="documents"></td>
                                                                            <td> <input type="radio" value="2" <?php if (isset($userpermissioninfo->documents)) {
                                            echo ($userpermissioninfo->documents == '2' ? 'checked' : '');
                                        } ?> name="documents"></td>
                                                                            <td><input type="radio" value="3" <?php if (isset($userpermissioninfo->documents)) {
                                            echo ($userpermissioninfo->documents == '3' ? 'checked' : '');
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="radio" value="1" <?php if (isset($userpermissioninfo->commenting)) {
                                            echo ($userpermissioninfo->commenting == '1' ? 'checked' : '');
                                        } ?> name="commenting"></td>
                                                                            <td> <input type="radio" value="2" <?php if (isset($userpermissioninfo->commenting)) {
                                            echo ($userpermissioninfo->commenting == '2' ? 'checked' : '');
                                        } ?> name="commenting"></td>
                                                                            <td> <input type="radio" value="3" <?php if (isset($userpermissioninfo->commenting)) {
                                            echo ($userpermissioninfo->commenting == '3' ? 'checked' : '');
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td> <input type="radio" value="1" <?php if (isset($userpermissioninfo->messaging)) {
                                            echo ($userpermissioninfo->messaging == '1' ? 'checked' : '');
                                        } ?>  name="messaging"></td>
                                                                            <td>&nbsp;</td>
                                                                            <td> <input type="radio" value="3" <?php if (isset($userpermissioninfo->messaging)) {
                                            echo ($userpermissioninfo->messaging == '3' ? 'checked' : '');
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="radio" value="1" <?php if (isset($userpermissioninfo->billing)) {
                                            echo ($userpermissioninfo->billing == '1' ? 'checked' : '');
                                        } ?> name="billing"></td>
                                                                            <td><input type="radio" value="2" <?php if (isset($userpermissioninfo->billing)) {
                                            echo ($userpermissioninfo->billing == '2' ? 'checked' : '');
                                        } ?> name="billing"></td>
                                                                            <td> <input type="radio" value="3" <?php if (isset($userpermissioninfo->billing)) {
                                            echo ($userpermissioninfo->billing == '3' ? 'checked' : '');
                                                                ...
                                                                <div class="attorney-permissions-object-name" colspan="4">
                                                                    <label class="time-entries-expenses-label">
                                                                        <input class="time-entries-expenses-checkbox" <?php if (isset($userpermissioninfo->time_entries_expense)) {
                                                                ...
                                                                <table class="permissions table table-bordered">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="attorney-permissions-object-choice"><input type="radio" value="4" <?php if (isset($userpermissioninfo->Reporting)) {
                                            echo ($userpermissioninfo->Reporting == '4' ? 'checked' : '');
                                        } ?> name="Reporting"></td>
                                                                            <td class="attorney-permissions-object-choice"><input type="radio" value="5" <?php if (isset($userpermissioninfo->Reporting)) {
                                            echo ($userpermissioninfo->Reporting == '5' ? 'checked' : '');
                                        } ?> name="Reporting"></td>
                                                                            <td class="attorney-permissions-object-choice"><input type="radio" value="6" <?php if (isset($userpermissioninfo->Reporting)) {
                                                                    ...
                                                                    <tbody><tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="permission-details-yes">
                                                                                <input type="radio" value="1" <?php if (isset($userpermissioninfo->accessable_case)) {
                                            echo ($userpermissioninfo->accessable_case == '1' ? 'checked' : '');
                                                                            ...
                                                                            <td class="permission-details-no">
                                                                                <input type="radio" value="2" <?php if (isset($userpermissioninfo->accessable_case)) {
                                            echo ($userpermissioninfo->accessable_case == '2' ? 'checked' : '');
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="permission-details-yes">
                                                                                <input type="radio" value="1" <?php if (isset($userpermissioninfo->add_firm_user)) {
                                            echo ($userpermissioninfo->add_firm_user == '1' ? 'checked' : '');
                                                                            ...
                                                                            <td class="permission-details-no">
                                                                                <input type="radio" value="2" <?php if (isset($userpermissioninfo->add_firm_user)) {
                                            echo ($userpermissioninfo->add_firm_user == '2' ? 'checked' : '');
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="permission-details-yes">
                                                                                <input type="radio" value="1" <?php if (isset($userpermissioninfo->edit_user_permission)) {
                                            echo ($userpermissioninfo->edit_user_permission == '1' ? 'checked' : '');
                                                                            ...
                                                                            <td class="permission-details-no">
                                                                                <input type="radio" value="2" <?php if (isset($userpermissioninfo->edit_user_permission)) {
                                            echo ($userpermissioninfo->edit_user_permission == '2' ? 'checked' : '');
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="permission-details-yes">
                                                                                <input type="radio" value="1" <?php if (isset($userpermissioninfo->delete_item)) {
                                            echo ($userpermissioninfo->delete_item == '1' ? 'checked' : '');
                                                                            ...
                                                                            <td class="permission-details-no">
                                                                                <input type="radio" value="2" <?php if (isset($userpermissioninfo->delete_item)) {
                                            echo ($userpermissioninfo->delete_item == '2' ? 'checked' : '');
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="permission-details-yes">
                                                                                <input id="firm_manager_183428_true" type="radio" value="1" <?php if (isset($userpermissioninfo->manage_billing_payment)) {
                                            echo ($userpermissioninfo->manage_billing_payment == '1' ? 'checked' : '');
                                                                            ...
                                                                            <td class="permission-details-no">
                                                                                <input id="firm_manager_183428_false" type="radio" value="2" <?php if (isset($userpermissioninfo->manage_billing_payment)) {
