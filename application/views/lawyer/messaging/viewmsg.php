                                ...
                                <div class="panel-body">
                                    <div class="media">
                                        <div class="media-body">
                                            <h3 class="active"><strong><a href="<?php echo base_url() ?>messageing/inbox">Back To Messaging Center</a></strong></h3>
<!--                                            <h3 class="active"><strong><a href="<?php echo base_url() ?>inboxmsg">Inbox</a></strong></h3>
                                            <hr>
                                            <h3><strong><a href="<?php echo base_url() ?>atinboxmsg">Sent</a></strong></h3>
                                            <hr>
                                            <h3><strong><a href="<?php echo base_url() ?>atinboxmsg">Draft</a></strong></h3>
                                            <hr>
                                            <h3><strong><a href="<?php echo base_url() ?>atinboxmsg">Archive</a></strong></h3>
                                            <hr>-->
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-9">
                            <div class="row" style="background-color: #f6fbff;min-height: 70px;padding: 15px;">
                                <div>
                                    ...
                                    <span class="message_user_name">
                                        <a href="<?php echo base_url()?>edituserprofile/<?php echo $messageview->MessageTo; ?>">
                                            <?php    
                                            $usereditinfo = $this->MessageModel->getuserinfobyid($messageview->MessageTo);
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div id="case_link_text" style="float: left; margin-left: 5px; margin-top: 3px;">
                                            <a href="<?php echo base_url()?>cases/viewCase/<?php echo base64_encode($messageview->CaseId); ?>"><?php echo $messageview->CaseName; ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="comment_wrapper" style="border: 1px solid #ccd3d9; position: relative; border-radius: 3px;padding: 8px;background: #fff;">
                                        <div class="comment_header clearfix">
                                            <div style="font-weight: bold; float: left;">
                                                <a>
                                                    <?php
                                                        $usereditinfo = $this->MessageModel->getuserinfobyid($allmsg['MessageFrom']);
                                                        echo $usereditinfo->fullname;
                                                         ?>
                                                </a>
                                            </div>
                            ...
                            <div class="row" style="background-color: #f6fbff;min-height: 70px;padding: 15px;">
                                ...
                                <?php //echo '<pre>'; print_r($messageview);?>
                                <div class="col-md-11">
                                    <form id="comment_form" action="<?php echo base_url()?>ataddgroupbymsg/<?php echo $messageview->MessageId; ?>" accept-charset="UTF-8" data-remote="true" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="_method" value="put">
                                        ...
                                        <input type="hidden" name="MessageTo" id="new_message_user_id" value="<?php echo $messageview->MessageFrom; ?>">
                                        <textarea class="form-control FETextInput user-text" id="rsmsgtext" name="Content" placeholder="Type your comment here..."></textarea>
                                        <button type="submit" class="btn btn-default" style="float: right; margin-top: 10px; background: #EEEEEE; border: 1px solid #ddd;">
