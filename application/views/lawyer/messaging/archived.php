...
<!--                                                    <h3 class="box-title">Folders</h3>
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li><a href="<?php echo base_url().'messageing/archived'?>"><i class="fa fa-filter"></i> Archived <span class="label label-warning pull-right">65</span></a>
                                            </li>
                                                    ...
                                                    <div class="table-responsive mailbox-messages" style="width: 100%">
                                                        <table class="table table-striped" id="inboxtable">
                                                            <tbody>
                                                             ...
                                                             <?php foreach ($getarchived as $amessageList) {?>
                                                                    
                                                                
                                                                <tr>
                                                                    
                                                                    <td class="mailbox-star"><a href="<?php echo base_url().'archivedmessage/details/'.$amessageList->MessageId;?>"><i class="glyphicon glyphicon-eye-open"></i></a></td>
                                                                    <td class="mailbox-name"><a href="<?php echo base_url().'archivedmessage/details/'.$amessageList->MessageId;?>"><strong><?php if($amessageList->Subject){echo $amessageList->Subject;}?></strong></a></td>
