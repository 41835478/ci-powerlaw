                        ...
                        <div class="row">
                            <div class="col-sm-3">
                              ...
                              <div class="col-md-9" style="border-left: 1px solid #B2B2B2">
                                 <form id="w0"  onsubmit="return(validate());" name="f1" action="<?php echo base_url() . 'messaging/send' ?>" method="post">
                                    ...
                                    <div class="box box-primary ">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"class="form-control" name="mailSubject" placeholder="Subject:" value="">
                                            </div>
                                            <div class="form-group">
                                                <select class="js-example-basic-single" placeholder="Select a Case" name="cases">
                                                    <?php if($allCses){foreach($allCses as $aCses){?>
                                                    <option value="<?php echo $aCses->CaseId?>"><?php echo $aCses->CaseName?></option>
                                                    <?php }}?>
                                        ...
                                        <div class="box-footer">
                                            <div class="pull-right buttonRight">
                                                <button type="button"  id="draftid" class="btn btn-default"><i class="fa fa-pencil"></i> Draft</button>
