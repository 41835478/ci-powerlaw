                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="box box-solid">
                                                <div class="box-header with-border">
                                                     <?php if ($_SESSION['permissionsession']['messaging'] == '1') { ?>
                                                            ...
                                                            <tbody>
                                                             ...
                                                             <?php foreach ($messageList as $amessageList) {?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="mailbox-star"><a href="<?php echo base_url().'message/draftsend/'.$amessageList->MessageId;?>"><i class="glyphicon glyphicon-eye-open"></i></a><a style="margin-left: 10px; " href="<?php echo base_url().'message/delete/'.$amessageList->MessageId;?>"><i class="glyphicon glyphicon-trash"></i></a></td>
