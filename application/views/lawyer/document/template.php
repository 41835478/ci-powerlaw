                ...
                <div class="panel-body">
                    <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" class="table-responsive"> 
                        <table class="table table-bordered" id="firmdatatables" style="border: 1px solid #ddd;  word-wrap:break-word;">
                            ...
                            <tbody>
                                   <?php $i=1;foreach($alltemplate as $atemplate){?>                         
                                
                                <tr>
                                        <td><?php echo $i?></td>
                                        <td><?php if($atemplate['DocName']){?><a><?php echo $atemplate['DocName'];?></a><?php }?></td>
                                        <td></td>
                                        <td><?php if($atemplate['CreatedBy']){echo "Uploaded on".' '.date('d F, Y', strtotime($atemplate['EditedDate'])).' by ';?><a><?php if($alluser){foreach($alluser as $auser){if($atemplate['CreatedBy']==$auser->id){echo $auser->fullname;}}}?></a><?php }?></td>
                                        <td>
                                            <?php if ($_SESSION['permissionsession']['documents'] == '2' ||$_SESSION['permissionsession']['documents'] == '1') { ?>
                                            <a href="" title="Update" aria-label="Update" data-pjax="0"><span class="glyphicon glyphicon-eye-open"></span></a>
                                            <?php }?>
                                             <?php if ($_SESSION['permissionsession']['documents'] == '1') { ?>
                                            <a href="" title="Update" aria-label="Update" data-pjax="0"><span class="glyphicon glyphicon-comment"></span></a>
                                            <a href="" title="Update" aria-label="Update" data-pjax="0"><span class="glyphicon glyphicon-pencil"></span></a>
                                            <a class="alertForDelete" href="" title="Delete" aria-label="Delete" data-confirm="Are you sure you want to delete this item?" data-method="post" data-pjax="0"><span class="glyphicon glyphicon-trash"></span></a>
                                             <?php }?>
                                        </td>
                                    </tr>
                                    <?php $i++;}?> 
                    ...
                    <div class="modal-body" style="background:#F6F6F6; height: 300px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="background: #E3F4FF; height: 150px; border: 1px solid #B7B7B7; border-radius: 18px; width: 25%; margin-right: 10px; text-align: center; margin-left: 34px;">
                                <a href="" id="" data-toggle="modal" data-target="#margetemplete"><div style="margin-top: 28px;"><img src="<?php echo base_url() ?>assets/image/document_new_template.png"><p>Marge Template</p></div></a>
                            </div>
                            <div class="col-md-4" id="blankid" style="background: #E3F4FF; height: 150px; border: 1px solid #B7B7B7; border-radius: 18px; width: 25%; margin-right: 40px; text-align: center; float: right;">
                              
                           
                                <a href="<?php echo base_url().'documents/blankDocuments'?>" id="blankpageid"  target="_blank"><div style="margin-top: 28px;"><img src="<?php echo base_url() ?>assets/image/document_new_blank.png"><p>Blank page</p></div></a>
