<div class="page-header">
    <div class="page-header-content" style="background: #C8C8C8">
        <ol class="breadcrumb" style="padding-bottom: 10px;">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo base_url()?>contact/addContact">Add Contact</a></li>
        </ol>
    </div>
</div>
<!-- /page header -->
            ...
            <div class="content-wrapper">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Create Contact</h5>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="contact-form">
                            <hr />
                            <form id="w0"  onsubmit="return(validate());" name="f1" action="<?php echo base_url().'contact/create'?>" method="post">
                                        ...
                                        <div class="form-group field-contact-contactgroup">
                                            ...
                                            <select id="contact-contactgroup" class="select-search form-control" name="ContactGroup">
                                                ...
                                                <?php foreach ($all_group as $a_group) {?>
                                                  <option value="<?php echo $a_group->GroupId;?> <?php if(set_value('ContactGroup')==$a_group->GroupId){echo 'selected';}?>"><?php echo $a_group->GroupName;?></option>  
                                                <?php }?>
                                            </select>
                                        ...
                                        <div class="form-group field-contact-companyid">
                                            ...
                                            <select id="contact-companyid" class="select-search form-control" name="CompanyId" onchange="loadModel(this.value);">
                                                ...
                                                <?php foreach ($all_company as $a_company) {?>
                                                 <option value="<?php echo $a_company->CompanyId;?>" <?php if(set_value('CompanyId')==$a_company->CompanyId){echo 'selected';}?>><?php echo $a_company->CompanyName;?></option> 
                                                <?php }?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <label style="margin-bottom: 0px;">Mobile Number &nbsp; &nbsp;</label>
                                          ...
                                          <span  style="color: red;"><?php echo form_error('CCodeM');?></span>
                                        <div class="form-group field-contact-ccodem">
                                            ...
                                            <select id="contact-ccodem" class="form-control" name="CCodeM" onchange="getState(this.value)" style="width: 37%; float: left; margin-right: 10px;">
                                                ...
                                                <option value="<?php echo $a_country_mobile_code->PhoneCode?>" <?php if(($a_country_mobile_code->PhoneCode)==(set_value('CCodeM'))){echo "selected";}?>><?php echo $a_country_mobile_code->CountryCode.'('.$a_country_mobile_code->PhoneCode.')';?></option>
                                                <?php }?>
                                          ...
                                          <div class="form-group field-contact-mobile required">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <label style="margin-bottom: 0px;">Phone Number &nbsp; &nbsp;</label>
                                         <span  style="color: red; margin-top: 20px;"><?php echo form_error('CCodeP');?></span>
                                        ...
                                        <div class="form-group field-contact-ccodep">
                                            ...
                                            <select id="contact-ccodep" class="form-control" name="CCodeP" onchange="getState(this.value)" style="width: 37%; float: left; margin-right: 10px;">
                                                <option value="">Select One</option>
                                                <?php foreach ($all_country_mobile_code as $a_country_mobile_code) {?>
                                                <option value="<?php echo $a_country_mobile_code->PhoneCode?>" <?php if(($a_country_mobile_code->PhoneCode)==(set_value('CCodeP'))){echo "selected";}?>><?php echo $a_country_mobile_code->CountryCode.'('.$a_country_mobile_code->PhoneCode.')';?></option>
                                                <?php }?>
                                        ...
                                        <div class="form-group field-contact-country required">
                                            ...
                                            <select id="contact-country" class="select-search form-control" name="Country" onchange="getState(this.value)">
                                                <option value="">Select Country</option>
                                                 <?php foreach ($all_country_mobile_code as $a_country_mobile_code) {?>
                                                <option value="<?php echo $a_country_mobile_code->CountryId?>" <?php if(set_value('Country')==$a_country_mobile_code->CountryId){echo "selected";}?>><?php echo $a_country_mobile_code->CountryName;?></option>
                                                <?php }?>
                                            </select>
                                        ...
                                        <div class="form-group field-contact-state">
                                            ...
                                            <select id="contact-state" class="select-search form-control" name="State">
                                                <option value="">Select State</option>
                                                 <?php foreach ($all_country_mobile_code as $a_country_mobile_code) {?>
                                                <option value="<?php echo $a_country_mobile_code->CountryId?>" <?php if(set_value('State')==$a_country_mobile_code->CountryId){echo 'selected';}?>><?php echo $a_country_mobile_code->State;?></option>
                                                <?php }?>
                                            </select>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-contact-zipcode">
                                            <label class="control-label" for="contact-zipcode">Zip Code &nbsp;&nbsp;</label>
                                             <span id="commentZipCode" style="color: red;"></span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-contact-allowportalaccess required">
                                            ...
                                            <select id="contact-allowportalaccess" class="select-search form-control" name="AllowPortalAccess">
                                                <option value="">Select One</option>
                                                <option value="Yes" <?php if(set_value('AllowPortalAccess')=='Yes'){echo 'selected';}?>>Yes</option>
                                                <option value="No" <?php if(set_value('AllowPortalAccess')=='No'){echo 'selected';}?>>No</option>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group field-contact-dateofbirth">
                                            ...
                                            <div class="input-group col-sm-12">
                                                ...
                                                <input type="text" id="birthdate" class="pickadate-editable form-control" name="DateOfBirth" data-provide="datepicker"
                                                       value="<?php echo set_value('DateOfBirth'); ?>">
                                            </div>
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-contact-dateofanniversary">
                                            ...
                                            <div class="input-group col-sm-12">
                                                ...
                                                <input type="text" id="anydate" class="pickadate-editable form-control" name="DateOfAnniversary" data-provide="datepicker" value="<?php echo set_value('DateOfAnniversary'); ?>">
                                            </div>
                                            <div class="help-block"></div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-contact-licencenumber">
                                            ...
                                            <span id="commentlicence" style="color: red;"></span>
                                            <input type="text" id="contact-licencenumber" class="form-control" name="LicenceNumber" maxlength="255" value="<?php echo set_value('LicenceNumber'); ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-contact-welcomemessage">
                                            ...
                                            <textarea id="contact-welcomemessage" class="form-control" name="WelcomeMessage" rows="1" style="resize: none;"><?php echo set_value('WelcomeMessage'); ?></textarea>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group field-contact-privatenote">
                                            ...
                                            <textarea id="contact-privatenote" class="form-control" name="PrivateNote" rows="1" style="resize: none;"><?php echo set_value('PrivateNote'); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <button type="submit" class="btn btn-success">Create Contact</button>        </div>
                                </div>
...
function validate()
{
    ...
    if (isNaN(document.f1.ZipCode.value))
      {  
     commentZipCode="Zip Code should be a number!";
