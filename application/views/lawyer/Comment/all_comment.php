<div class="page-header">
    <div class="page-header-content" style="background: #C8C8C8">
        <ol class="breadcrumb" style="padding-bottom: 10px;">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo base_url() ?>Comment/allcomment">Comments</a></li>
        </ol>
    </div>
</div>
<!-- /page header -->
                            ...
                            <div class="table-responsive">          
                                <table class="table table-bordered table-hover">
                                    <?php if ($allComment) { ?>
                                        ...
                                        <?php foreach ($allComment as $aComment) { ?>

                                            <tr>



                                                <td onclick="return(newone(<?php echo $aComment->comment_id ?>))">
                                            ...
                                            ?> <a class="pull-right"><span class="glyphicon glyphicon-book"></span><?php
                                                                if ($aComment->case_id) {
                                                                    foreach ($allCases as $aCase) {
                                                                        if ($aComment->case_id == $aCase->CaseId) {
                                                                            echo' ' . $aCase->CaseName;
                                                                        }
                                                                    }
                                                                }
                                                                ?></a></p>
                                                        <p style="text-align:centre"> <span class="glyphicon glyphicon-comment"></span> <?php if ($aComment->comment) {
...
<script>
    function newone(v) {
        ...
        $.ajax({
            url: '<?php echo site_url('Comment/get_comment_details'); ?>',
            type: 'POST',
            data: {
                commentid: v
            },
