                ...
                <div class="panel-body">
                    ...
                    <div class="">
                        <table class="table table-bordered table-hover table-striped text-centered" id="assetsdata" style=" border-radius: 5px;width: 50%;margin: 0px auto;float: none;">
                            <thead>
                                <tr>
                                    <th style="text-align:center; vertical-align:middle; border: 2px solid #808080; padding: 10px; width: 220px">Time Zone</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($alltimezoneinfo as $timezone) { ?>						
                                    <tr>
                                        <td style="text-align:center; vertical-align:middle; border: 1px solid #808080; padding: 5px; width: 220px"><?php echo $timezone['TimezoneName']; ?></td>
                                <?php } ?>
                            </tbody>
