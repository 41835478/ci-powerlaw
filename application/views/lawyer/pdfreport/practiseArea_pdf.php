        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <i class="glyphicon glyphicon-stats"></i><h3> All Practise Area</h3>                            
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <table class="table table-bordered table-hover table-striped" id="assetsdata">
                            <thead>
                                <tr>
                                    <th style="text-align:center; vertical-align:middle; border: 2px solid #808080; padding: 10px; width: 220px">Area Name</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($allpracticearea as $area) { ?>						
                                    <tr>
                                        <td style="text-align:center; vertical-align:middle; border: 1px solid #808080; padding: 5px; width: 220px"><?php echo $area->PracticeArea; ?></td>
                                    </tr>
<?php } ?>
                            </tbody>
